...
<div class="container my-4">
    <div class="card shadow p-4 form-title-card visible">
        <div class="card-header text-white d-flex align-items-center justify-content-center mb-4"
            style="background-color: #198754 !important; color: #f5f5f5 !important;">
                    ...
                    <div class="card p-3 h-100 identitas-card visible">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="form-label fw-bold text-gray"><i class="fas fa-user-nurse me-1"></i> Pemberi Informasi</label>
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="form-label fw-bold text-gray"><i class="fas fa-user me-1"></i> Penerima Informasi</label>
                    ...
                    <div class="card p-3 h-100 subjektif-card visible">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_persetujuan" required>
                                <div class="invalid-feedback">Nama wajib diisi.</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold text-info"><i class="fas fa-home me-1"></i> Alamat</label>
                                <input type="text" class="form-control" name="alamat_persetujuan" required>
                                <div class="invalid-feedback">Alamat wajib diisi.</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold text-info"><i class="fas fa-calendar-alt me-1"></i> Tanggal Lahir</label>
                                <input type="date" class="form-control" name="tgl_lahir_persetujuan" required>
                                <div class="invalid-feedback">Tanggal lahir wajib diisi.</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mb-3 d-flex align-items-stretch">
                <div class="col-md-12">
                    <div class="card p-3 h-100 subjektif-card visible">
                        ...
                        <div class="card-body">
                            <label class="form-label fw-bold text-info mb-3"><i class="fas fa-check-circle me-1"></i> Dengan ini menyatakan PERSETUJUAN untuk dilakukannya tindakan anestesi terhadap:</label>
                            <div class="d-flex flex-wrap gap-3 mb-3">
                                ...
                                ?>
                                <div class="invalid-feedback d-block">Pilih salah satu opsi.</div>
                            </div>
                            <div class="mb-3">
